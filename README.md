...
|UniProcessor| [UniProcessor: A Text-induced Unified Low-level Image Processor]() |  |ECCV 2024 |[![Stars](https://img.shields.io/github/stars/Dragonisss/RAM.svg?style=social&label=Star)](https://github.com/Dragonisss/RAM) | |
|GRIDS| [GRIDS: Grouped Multiple-Degradation Restoration with Image Degradation Similarity](https://arxiv.org/abs/2407.12273) | 30 degradation types|ECCV 2024 | | Mining the relationship between multiple degradations|
